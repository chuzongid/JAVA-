...
//		}
		...
		//data 배열에는 3학년 1반의 키가 저장되어있다.
		//키가 175이상 만 출력하세요.
		for( int i=0; i<data.length; i++) {
			if(data[i]>=175)
				System.out.println("175이상 학생 - "+(i+1)+"번쨰 학생 키 : "+data[i]+" ");
		}
	}
...
// 자바에서 기본 배열을 생성하여 다룰떄
// 배열에 저장할 데이터 정하기( 저장 데이터에 따라 데이터 타입정해야함 )
...
// sort - 내림차순 정렬
// Arrays.toString();
// System.arraycopy(복사대상배열,복사배열시작인덱스,복사저장할배열,저장위치,몇개복사);